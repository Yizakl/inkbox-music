...
- 修复从音乐库移除正在播放歌曲后，UI 消失但音乐仍继续播放的问题。
- 删除当前播放歌曲时会立即停止播放，并清空 PlayerBar / NowPlayingPage 状态。

### 技术改进

- 优化播放状态清理逻辑。
- 优化歌单、主题、桌面歌词相关状态管理。
- 保持与原有音乐库、喜欢列表、歌词、封面和三点菜单功能兼容。

## Release 1.0

- 本地音乐导入与播放
- MP3、FLAC、WAV、M4A 支持
- 音频 metadata、时长和内嵌封面读取
- LRC 歌词解析与同步
- Apple Music 风格歌词显示
- 点击歌词跳转播放时间
- 手动滚动后的“回到当前歌词”
